...
export interface ShareData {
  ...
  bloomDominantLevel?: string;
  keySubtasks?: string[];
  recentTasks?: Array<{ title: string; completedCount: number; totalCount: number }>;
  quote?: string;
  stats?: {
    streak: number;
    todayCount: number;
...
export function ShareCardModal({ isOpen = true, onClose, data }: ShareCardModalProps) {
  ...
  const completedCount = data.completedSubtasksCount ?? subtasks.filter((s) => s.completed).length;
  const totalSubtasks = data.totalSubtasksCount ?? (subtasks.length || completedCount || 1);
  const deepWorkHours =
    data.deepWorkHours ?? subtasks.reduce((sum, s) => sum + (s.durationDays || 1) * 1.5, 0);
  ...
  const handleCopyImage = useCallback(async () => {
    ...
    try {
      ...
      console.error(err);
      setErrorMsg(err instanceof Error ? err.message : "复制失败，请点击下载保存");
    } finally {
      setCopying(false);
    }
  }, []);
      ...
      >
            ...
            >
              <button
                ...
                style={{
                  ...
                  borderRadius: 6,
                  border: "none",
                  background: activeTab === "certificate" ? "var(--accent)" : "transparent",
                  color: activeTab === "certificate" ? "#fff" : "var(--muted-foreground)",
                  cursor: "pointer",
              ...
              <button
                ...
                style={{
                  ...
                  borderRadius: 6,
                  border: "none",
                  background: activeTab === "weekly_report" ? "var(--accent)" : "transparent",
                  color: activeTab === "weekly_report" ? "#fff" : "var(--muted-foreground)",
                  cursor: "pointer",
                  transition: "all 0.15s ease",
                }}
              >
            ...
            >
              <button
                ...
                style={{
                  ...
                  borderRadius: 6,
                  border: "none",
                  background: theme === "ivory" ? "var(--secondary)" : "transparent",
                  color: theme === "ivory" ? "var(--foreground)" : "var(--muted-foreground)",
                  cursor: "pointer",
                }}
              >
                📜 典雅象牙
              ...
              <button
                ...
                style={{
                  ...
                  borderRadius: 6,
                  border: "none",
                  background: theme === "obsidian" ? "var(--secondary)" : "transparent",
                  color: theme === "obsidian" ? "var(--foreground)" : "var(--muted-foreground)",
                  cursor: "pointer",
                }}
              >
                🌑 黑曜暗金
          ...
          >
            ...
            {activeTab === "certificate" ? (
              <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
                ...
                <div style={{ textAlign: "center", marginTop: 4 }}>
                  <div
                    style={{
                      ...
                      alignItems: "center",
                      gap: 4,
                      background: isDark ? "rgba(234,179,8,0.15)" : "rgba(180,83,9,0.1)",
                      border: isDark ? "1px solid rgba(234,179,8,0.3)" : "1px solid rgba(180,83,9,0.25)",
                      borderRadius: 99,
                      padding: "3px 12px",
                ...
                >
                  <div>
                    <div style={{ fontSize: 10, color: isDark ? "#9CA3AF" : "#71717A" }}>
                      完成子阶段
                    </div>
                    <div
                      style={{
                  ...
                  <div
                    style={{
                      borderLeft: isDark ? "1px solid #243048" : "1px solid #E8E2D8",
                      borderRight: isDark ? "1px solid #243048" : "1px solid #E8E2D8",
                    }}
                  >
                    <div style={{ fontSize: 10, color: isDark ? "#9CA3AF" : "#71717A" }}>
                      深度专注
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
                ...
                >
                  ...
                  >
                    ...
                    >
                      {data.stats?.streak || 1}
                      <span style={{ fontSize: 11, fontWeight: 500, marginLeft: 3 }}>天</span>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    >
                      {data.stats?.weekCount || completedCount || 3}
                      <span style={{ fontSize: 11, fontWeight: 500, marginLeft: 3 }}>个任务</span>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    >
                      {data.stats?.totalCompleted || completedCount || 8}
                      <span style={{ fontSize: 11, fontWeight: 500, marginLeft: 3 }}>阶段</span>
                    </div>
                  </div>
                ...
                >
                  ...
                  >
                    <span>布鲁姆认知阶梯结构</span>
                    <span style={{ fontFamily: "monospace", fontSize: 10 }}>Bloom Tax.</span>
                  </div>

                  {/* 6 阶梯条形指示器 */}
                  <div style={{ display: "flex", flexDirection: "column", gap: 5 }}>
                    {[
                      { label: "L6 创造与输出", color: "#EC4899", pct: "90%" },
                      { label: "L5 评价与批判", color: "#F97316", pct: "85%" },
                      { label: "L4 分析与解构", color: "#FBBF24", pct: "100%" },
                      { label: "L3 应用与实操", color: "#34D399", pct: "100%" },
                      { label: "L2 理解与阐释", color: "#60A5FA", pct: "100%" },
                      { label: "L1 识记与检索", color: "#94A3B8", pct: "100%" },
                    ].map((step, i) => (
                      <div
                        key={i}
                        style={{
                ...
                <div
                  style={{
                    background: isDark ? "#161F30" : "#F5F2EB",
                    borderLeft: isDark ? "3px solid #6366F1" : "3px solid #2F5D50",
                    padding: "8px 10px",
        ...
        >
          <div style={{ fontSize: 12, color: "var(--muted-foreground)" }}>
            💡 复制图片后可直接在小红书、微信、X 对话框中按下 <kbd>Ctrl/⌘+V</kbd> 粘贴发送
          </div>
            ...
            >
              {copiedSuccess ? (
                <>
                  ...
                  <span style={{ color: "var(--success)" }}>已复制到剪贴板！</span>
                </>
              ) : copying ? (
                <span>生成中...</span>
              ) : (
